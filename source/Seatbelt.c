...
int main(int argc, char *argv[]) {
    ...
    window = SDL_CreateWindow("Seatbelt", 270, 215, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN | SDL_WINDOW_RESIZABLE);
    if(window == NULL) {
        printf("Window could not be shown\n");
    }
    renderer = SDL_CreateRenderer(window, -1, 0);
    SDL_Surface *image = IMG_Load(get_data("seatbelt_ECU.png"));
