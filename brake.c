...
int main(int argc, char *argv[]) {
  ...
  window = SDL_CreateWindow("brake", 301, 300, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN | SDL_WINDOW_RESIZABLE);
  if(window == NULL) {
